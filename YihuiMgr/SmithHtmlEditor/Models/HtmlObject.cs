...
namespace Smith.WPF.HtmlEditor
{
    ...
    public class ImageObject : HtmlObject
    {
        ...
        private bool isRelateWidthOrHeight;
        public bool IsRelateWidthOrHeight
        {
            get { return isRelateWidthOrHeight; }
            set
            {
                isRelateWidthOrHeight = value;
                RaisePropertyChanged("IsRelateWidthOrHeight");
            }
        }
